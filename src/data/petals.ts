export const PETALS = [
  { name: 'Równowaga', value: 80, icon: '⚖️',  hue: '#6b8f5e', light: '#8db87a', dark: '#3d5e34' },
  { name: 'Relaks',    value: 60, icon: '🪷',   hue: '#7a9ab8', light: '#9bbad8', dark: '#4a6a88' },
  { name: 'Sen',       value: 55, icon: '🌙',   hue: '#8878a8', light: '#a898c8', dark: '#5d4f80' },
  { name: 'Dieta',     value: 90, icon: '🍏',   hue: '#6aaa8a', light: '#8acaaa', dark: '#3e7a5e' },
  { name: 'Rozwój',    value: 45, icon: '💡',   hue: '#c88050', light: '#e8a070', dark: '#985830' },
  { name: 'Aktywność', value: 70, icon: '🏃',   hue: '#c06058', light: '#e08078', dark: '#903838' },
]

export const LAYERS = [
  { n: 6, seg: [10,16] as [number,number], off: Math.PI/4.5, tilt: -0.5, twist: 0.15, tall: 1.2, opacity: 1, tipFade: 0.3, emissive: true, sc: [0.7,0.95,1] as [number,number,number],
  ...
  { n: 6, seg: [14,20] as [number,number], off: Math.PI/7.5, tilt: -0.15, twist: 0.1, opacity: 0.75, sc: [1.15,1.0,1] as [number,number,number],
